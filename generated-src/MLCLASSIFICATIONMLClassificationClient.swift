...
public class MLCLASSIFICATIONMLClassificationClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "MLCLASSIFICATIONMLClassificationClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:MLCLASSIFICATIONMLClassificationClient = {
        ...
        return MLCLASSIFICATIONMLClassificationClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = MLCLASSIFICATIONMLClassificationClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `MLCLASSIFICATIONMLClassificationClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> MLCLASSIFICATIONMLClassificationClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         MLCLASSIFICATIONMLClassificationClient.registerClient(withConfiguration: configuration, forKey: "USWest2MLCLASSIFICATIONMLClassificationClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = MLCLASSIFICATIONMLClassificationClient.client(forKey: "USWest2MLCLASSIFICATIONMLClassificationClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(MLCLASSIFICATIONMLClassificationClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> MLCLASSIFICATIONMLClassificationClient {
		objc_sync_enter(self)
		if let client: MLCLASSIFICATIONMLClassificationClient = _serviceClients.object(forKey: key) as? MLCLASSIFICATIONMLClassificationClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			MLCLASSIFICATIONMLClassificationClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! MLCLASSIFICATIONMLClassificationClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://4wagom5zc8.execute-api.ap-southeast-1.amazonaws.com/ios"
